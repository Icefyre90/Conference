...
$config['pagination']['next_tag_open'] = '<li class="page-item"><a class="page-link" hidden=""  href="guest.php#cardlistpppp">';
...
$config['pagination']['last_tag_open'] = '<li class="page-item"><a class="page-link"  hidden="" href="guest.php#cardlistpppp">';
