...
--
-- Host: 127.0.0.1
-- Generation Time: May 25, 2018 at 07:45 PM
...
INSERT INTO `project` (`idproject`, `project_name`, `keywords`, `section_pro`, `apstract`, `field_idfield`) VALUES
(1, 'destabilizacija regiona', 'region', 'paja ', 'konjizacija u univerzumeu', 1),
(2, 'kost lomi rano', 'kosti casica', 'karaula', 'saw 3 ili neki drugi deo', 2),
(4, 'opet neki projekat', 'neka slobava', 'neki', 'dokle vise sa ovbom vrucinom', 1),
(6, 'pokfefiejf', 'kejkd operfj', '', 'eiuhfihfvnreifvneofjeo oiejfio jefpoej o ioenf ioejf', 1),
(7, 'eifohncefnefc', 'efe fefe fef ', '3', 'fweoi9jhfwefjwefwepfvwe', 1),
(8, 'otpadanje korisnika', 'korisnik se ukanalio', '1', 'Neki miodrag stalno kao autor', 1),
(9, 'Odlazak ljudi sa kosova', 'siptari seperatisti', 'kontra', 'Koliko godina se ratuju a nista ne uspevaju', 3),
(10, 'Neki projekat', 'nesto novo', 'bipolar', 'svaki dan nesto novo', 2),
(11, 'ponovo neki projekti', 'kljucne reci', 'kontra', 'neki abstrakt ili kasko se vec zove', 3),
(24, 'novi projeka t 17', 'neka rec', 'elektro', 'juenfoiefepfmewf', 1),
(25, 'novi projekat 18', 'erff fe ', 'bipolar', 'efefefefef', 2),
(26, 'neki projekat napredak', 'wedwedwdwd wd wd', 'bipolar', 'nefne fjef eof ej ef ', 2),
(27, 'projekat 1224', ' frf  fgr f rf', 'elektro', 'wdw dwd efd ef ef ef e ', 1);
...
--
ALTER TABLE `project`
  MODIFY `idproject` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
